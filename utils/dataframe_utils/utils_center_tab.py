...
def get_diagnostic_details_diagnostic_by_domain(df, custom_condition_tier=False, custom_test_tier=False):
    ...
    rename_map = {
        ...
        'test_name_pretty': 'Diagnostic',
        #'test_format': 'Diagnostic Format',
...
# @st.cache_data(ttl=3600)
def get_diagnostic_details_format_by_diagnostic(df, custom_condition_tier=False, custom_test_tier=False):
    df = df[[
            'test_name_pretty',
            #'test_name_short',
            'test_format',
...
def get_diagnostic_by_condition_diagnostic_by_condition(df, custom_condition_tier=False, custom_test_tier=False):
    df = df[[
            'conditionname',
...
# @st.cache_data(ttl=3600)
def get_diagnostic_by_medicine_diagnostic_by_medicine(df, custom_condition_tier=False, custom_test_tier=False):
...
# @st.cache_data(ttl=3600)
def get_diagnostic_by_cond_and_med_diagnostic_by_condition_and_medicine(df, custom_condition_tier=False, custom_test_tier=False):
    df = df[[
            'conditionname',
            'medicine',
            'test_name_pretty',
